...
//This is just another version with a sort of unprofesionnal name (i already had like two scripts named finalProject i ran out of ideas, see FinalProjectCode for the "official" final code)
